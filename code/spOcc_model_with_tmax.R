...
data_list <- readRDS("./data/nps_herbs_spOcc_data.rds")
...
saveRDS(out, paste0("wvnhp_herbs_spatialPlus_k100_", num_factors, "factors_modelRun_initial_", Sys.Date(), ".rds"))
...
saveRDS(out, paste0("wvnhp_herbs_spatialPlus_k100_", num_factors, "factors_modelRun_10foldCV_run2_", Sys.Date(), ".rds"))
